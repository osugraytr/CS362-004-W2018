...
//    printf("\n\nhere-> %d\n\n\n",G.hand[0][0]);
	...
	expected_hand1 = handCount1;
	expected_deck1 = deckCount1;
	

        //memcpy(G.hand[p], smithy, sizeof(int) * handCount0); // set all the cards to copper
        //G.handCount0[p] = handCount0;                 // set the number of cards on hand
        //memcpy(G.hand[p], smithy, sizeof(int) * maxhandCount0); // set all the cards to copper
